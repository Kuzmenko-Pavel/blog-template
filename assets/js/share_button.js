...
a2a_config.vars = {
    vars: ["menu_type", "static_server", "linkmedia", "linkname", "linkurl", "linkname_escape", ["http_s", "http:" != document.location.protocol ? "s" : ""], "show_title", "onclick", "num_services", "hide_embeds", "prioritize", "exclude_services", "custom_services", ["templates", {}], "orientation", ["track_links", !1], ["track_links_key", ""], "tracking_callback", "track_pub", "color_main", "color_bg", "color_border", "color_link_text", "color_link_text_hover", "color_arrow", "color_arrow_hover", ["localize", "", 1], ["add_services", !1, 1], "locale", "delay", "icon_color", "no_3p", "show_menu", "target"],
    process: function () {
        for (var e, a, t, n, o, i = a2a_config.vars.vars, l = 0, r = "a2a_", s = i.length; l < s; l++) if ("string" == typeof i[l] ? (e = i[l], a = window[r + e], n = !1) : (e = i[l][0], a = window[r + e], t = i[l][1], n = !0, o = i[l][2]), void 0 !== a && null != a) {
...
var a2a = a2a || {
    ...
    init: function (e, a, t) {
        var n, o, i, l, r, s, c = a2a.c, d = (a = a || {}, {}), u = null, p = {}, m = location.href,
            _ = function (e, a) {
                a2a.total++, a2a.n = a2a.total, a2a["n" + a2a.n] = e;
                var t, n, o = e.node = a2a.set_this_index(e.node), i = document.createElement("div"),
                    l = a2a.getData(o)["a2a-media"], r = a2a.getData(o)["a2a-title"], s = a2a.getData(o)["a2a-url"];
        ...
        if (o = c.target) if ("string" == typeof o) {
    ...
    button: function (e) {
        var a = a2a.gEl, t = e.node, n = e.type, o = "a2a" + n, i = a(o + "_dropdown"), l = a(o + "_full"),
            r = a2a.has_menter, s = t.firstChild, c = a2a[n].onclick;
        t.getAttribute("onclick") && -1 != (t.getAttribute("onclick") + "").indexOf("a2a_") || t.getAttribute("onmouseover") && -1 != (t.getAttribute("onmouseover") + "").indexOf("a2a_") || (a2a.add_event(t, "click", function (e) {
            ...
            var r = "none" !== i.style.display, s = document.activeElement;
        ...
        }), a2a.add_event(t, "click", a2a.stopPropagation), a2a.add_event(t, "touchstart", a2a.stopPropagation, !!a2a.evOpts() && {passive: !0}), !a2a[a2a.type].onclick && r && (a2a.c.delay ? t.onmouseenter = function () {
    ...
    kit: function (e, a) {
        var t, n, o, i, l, r = a2a.type, s = {
            ...
            d = a2a.counters.avail, u = function (e, a) {
                if (e && !a2a.in_array(e, c)) for (var t = 0, n = a ? a2a[r].services : a2a.services, o = n.length; t < o; t++) if (e == n[t][1]) return [n[t][0], n[t][2], n[t][3], n[t][4], n[t][5]];
                return !a && [e, e]
            }, p = function (e, a) {
                ...
                var o = {node: t, service: a, title: E, url: x, media: C, mediaNode: g.a2a_mediaNode},
                    i = a2a.cbs("share", o);
            ...
            }, f = a2a.c.templates, g = e.node, h = a2a.getData(g), v = g.a2a_follow,
            y = a2a.HTMLcollToArray(g.getElementsByTagName("a")), k = y.length, w = document.createElement("div"),
            b = encodeURIComponent, x = e.linkurl, A = b(e.linkurl).replace(/'/g, "%27"), E = e.linkname,
            C = (b(e.linkname).replace(/'/g, "%27"), e.linkmedia),
            B = (C && b(e.linkmedia).replace(/'/g, "%27"), h["a2a-icon-color"] || a2a.c.icon_color),
            S = B ? B.split(",", 2) : B, F = S ? S[0] : S, N = S ? S[1] : S,
            T = g.className.match(/a2a_kit_size_([\w\.]+)(?:\s|$)/), L = T ? T[1] : "16", D = L + "px",
            z = "a2a_svg a2a_s__default a2a_s_", I = {}, M = {},
            P = e.linkurl_implicit && a2a.canonical_url ? encodeURIComponent(a2a.canonical_url).replace(/'/g, "%27") : A,
            j = g.className.indexOf("a2a_vertical_style") >= 0;
        L && !isNaN(L) && (a2a.svg.load(), B && "unset" != B && a2a.svg.works() && (F && "unset" != F && (I.backgroundColor = F), N && "unset" != N.trim() && (N = N.trim())), g.style.lineHeight = M.height = M.lineHeight = D, M.width = 2 * L + "px", M.fontSize = "16px", j && (M.height = M.lineHeight = L / 2 + "px", M.fontSize = "10px", M.width = L + "px"), 32 != L && (I.backgroundSize = I.height = I.lineHeight = I.width = D, M.borderRadius = I.borderRadius = (.14 * L).toFixed() + "px", M.fontSize = (parseInt(M.height, 10) + (j ? 4 : 0)) / 2 + "px")), a2a.kit.facebook_like = function () {
            ce.href = x, ce.width = "90", ce.layout = "button_count", ce.ref = "addtoany", ce = p(G, ce), G.style.width = ce.width + "px";
            var e, a, t, n, o = a2a.i18n();
            for (var i in 2 == (o = o ? o.replace(/-/, "_") : "en_US").length && (o += "_" + o.toUpperCase()), ce) se += " data-" + i + '="' + ce[i] + '"';
            ...
            var e = f.twitter, a = "string" == typeof e ? e.lastIndexOf("@") : null;
            a && -1 !== a && (a++, a = (a = e.substr(a).split(" ", 1))[0].replace(/:/g, "").replace(/\//g, "").replace(/-/g, "").replace(/\./g, "").replace(/,/g, "").replace(/;/g, "").replace(/!/g, ""), ce.related = a + ",AddToAny"), ce = p(G, ce);
            var t, n, o, i, l, r = document.createElement("a");
            for (var s in r.className = "twitter-share-button", ce) r.setAttribute("data-" + s, ce[s]);
            G.appendChild(r), a2a.kit.twitter_tweet_script || (t = document, n = "twitter-wjs", l = t.getElementsByTagName("script")[0], t.getElementById(n) || ((i = t.createElement("script")).id = n, i.src = "https://platform.twitter.com/widgets.js", l.parentNode.insertBefore(i, l), window.twttr = window.twttr || (o = {
                _e: [],
                ready: function (e) {
                    o._e.push(e)
                }
                ...
                twttr.ready(function (e) {
                    a2a.twitter_bind || (e.events.bind("click", function (e) {
                        if (e && "tweet" == e.region) {
                            ...
                            a && a.url && (a2a.GA.track("Twitter Tweet", "twitter_tweet", unescape(a.url), "pages", "AddToAny Share/Save Button"), _("Twitter Tweet", G))
                        }
            ...
            ce["pin-config"] = "beside", ce["pin-do"] = "buttonPin", ce.media = C, ce.url = x, ce = p(G, ce);
            var e, a, t, n = document.createElement("a");
            for (var o in ce) n.setAttribute("data-" + o, ce[o]);
            "beside" == ce["pin-config"] && "buttonPin" == ce["pin-do"] && (G.style.width = "76px"), n.href = "https://www.pinterest.com/pin/create/button/?url=" + ce.url + (ce.media ? "&media=" + ce.media : "") + (ce.description ? "&description=" + encodeURIComponent(ce.description).replace(/'/g, "%27") : ""), a2a.add_event(G, "click", function () {
                a2a.GA.track("Pinterest Pin", "pinterest_pin", x, "pages", "AddToAny Share/Save Button"), _("Pinterest Pin", G)
            ...
            for (var e in ce.onsuccess = "a2a.kit.linkedin_share_event", ce.url = x, ce = p(G, ce)) se += " data-" + e + '="' + ce[e] + '"';
            var a, t, n;
            a2a.kit.linkedin_share_event = function () {
                a2a.GA.track("LinkedIn Share", "linkedin_share", x, "pages", "AddToAny Share/Save Button"), _("LinkedIn Share", G)
            }, a2a.kit.linkedin_share_script || (a = document, t = a.createElement("script"), n = a.getElementsByTagName("script")[0], t.type = "text/javascript", t.async = !0, t.src = "https://platform.linkedin.com/in.js", n.parentNode.insertBefore(t, n)), a2a.kit.linkedin_share_script = 1, G.innerHTML = '<script type="IN/Share"' + se + "><\/script>"
        }, a2a.kit.google_plus = function () {
            window.google_plus_cb_a2a = function (e) {
                e.state && "off" == e.state || (a2a.GA.track("Google +1", "google_plusone", e.href, "pages", "AddToAny Share/Save Button"), _("Google +1", G))
            }, ce.href = x, ce.size = "medium", ce.annotation = "bubble", "google_plus_share" == K && (ce.action = "share"), ce = p(G, ce);
            var e, a, t, n = a2a.i18n() || "en-US";
            for (var o in window.___gcfg = window.___gcfg || {lang: n}, ce) se += " data-" + o + '="' + ce[o] + '"';
            G.innerHTML = '<div class="g-plus' + ("share" == ce.action ? "" : "one") + '" data-callback="google_plus_cb_a2a"' + se + "></div>", a2a.kit.google_plus_script || (e = document, a = e.createElement("script"), t = e.getElementsByTagName("script")[0], a.type = "text/javascript", a.async = !0, a.src = "https://apis.google.com/js/platform.js", t.parentNode.insertBefore(a, t), a2a.kit.google_plus_script = 1)
        }, a2a.kit.google_plusone = a2a.kit.google_plus_share = a2a.kit.google_plus;
        for (var R = 0; R < k; R++) {
            var H, O, $, U, G = y[R], q = G.className, W = q.match(/a2a_button_([\w\.]+)(?:\s|$)/),
                Y = q.indexOf("a2a_dd") >= 0, V = q.indexOf("a2a_counter") >= 0, K = !!W && W[1], J = G.childNodes,
                X = u(K), Q = v && s[K] ? s[K].name : X[0], Z = " noopener", ee = "_blank",
                ae = v && s[K] ? s[K].icon : X[1], te = v && s[K] ? s[K].color : X[2] || "CAE0FF", ne = X[3] || {},
                oe = ne.type, ie = X[4], le = !1, re = !1, se = "", ce = {};
            if (Y ? (a.target = G, a2a.init(r, a, 1), K = "a2a", te = "0166FF", ae = "a2a", re = !!V && 1) : "feed" == K || "print" == K ? (ee = "", Z = "") : V && K && a2a.in_array(K, d) ? re = 1 : K && a2a.in_array(K, c) && (a2a.kit[K](), le = 1), K && !le) {
                if (Y || (G.target = ee, !v || !s[K] && u(K, !0) ? "feed" == K ? G.href = G.href || e.linkurl : (G.href = "/#" + K, a2a.add_event(G, "mousedown", m), a2a.add_event(G, "keydown", m), G.rel = "nofollow" + Z) : G.href = (n = K, o = void 0, void 0, l = void 0, i = p(t = G, {})["a2a-follow"], l = s[n], i && l && (o = l.url.replace("${id}", i)), o || t.href), G.a2a = {}, G.a2a.customserviceuri = ie, G.a2a.stype = oe, G.a2a.linkurl = e.linkurl, G.a2a.servicename = Q, G.a2a.safename = K, ne.src && (G.a2a.js_src = ne.src), ne.url && (G.a2a.url = ne.url), ne.pu && (G.a2a.popup = 1), ne.media && (G.a2a.media = 1), v || a2a.add_event(G, "click", function (e, a, t, n, o) {
                        return function (i) {
                            var l = screen.height,
                    ...
                    for (var de, ue = 0, pe = J.length; ue < pe; ue++) if (de = J[ue].className, 1 == J[ue].nodeType && "a2a_label" != de && (U = !0, "string" == typeof de && de.indexOf("a2a_count") >= 0)) {
                        $ = !0;
                        break
                    }
                    if (!U) {
                        for (var me in(H = document.createElement("span")).className = z + ae + " a2a_img_text", te && (H.style.backgroundColor = "#" + te), "pending" !== (O = a2a.svg.get(ae, H, N)) && (H.innerHTML = O), I) H.style[me] = I[me];
                        G.insertBefore(H, J[0])
                    }
                } else {
                    for (var me in(H = document.createElement("span")).className = z + ae, te && (H.style.backgroundColor = "#" + te), "pending" !== (O = a2a.svg.get(ae, H, N)) && (H.innerHTML = O), I) H.style[me] = I[me];
                    G.appendChild(H), (H = document.createElement("span")).className = "a2a_label", H.innerHTML = Q || ("feed" == r ? a2a.c.localize.Subscribe : a2a.c.localize.Share), G.appendChild(H)
                }
                if (j && L && L < 20 && (re = !1), re && !$) {
                    for (var me in(H = document.createElement("span")).className = "a2a_count", H.a2a = {}, H.a2a.kit = g, M) H.style[me] = M[me];
                    G.appendChild(H), Y ? (H.a2a.is_a2a_dd_counter = 1, a2a.counters.get("facebook", H, P), g.a2a_dd_counter = H) : a2a.counters.get(K, H, P)
                }
                "a2a_dd" != q && a2a.kit_services.push(G)
            }
        }
    ...
    counters: {
        get: function (e, a, t, n) {
            a2a_config.counts;
            var o, i, l = decodeURIComponent(t), r = a2a.counters.bonus(e, l, t, a.a2a.kit), s = "",
                c = a2a.counters[e], d = c.api, u = (c.cb, a.a2a.is_a2a_dd_counter);
            !n && r && (s = "2", a2a.counters.get(e, a, r, !0)), "undefined" == typeof(o = c[l] = c[l] || {}).num ? (o.queued = o.queued || [], o.queued.push(a), c.n = c.n || 0, c.n++, c["cb" + c.n] = function (t) {
                ...
                if (void 0 !== n) for (var i = 0; i < o.queued.length; i++) queued_count_element = o.queued[i], o.num = n, queued_count_element.a2a.is_a2a_dd_counter ? a2a.counters.sum(queued_count_element, n, e + s) : a2a.counters.set(queued_count_element, n, e + s)
        ...
        sum: function (e, a, t) {
            var n = e.a2a.kit, o = n.a2a_counts_sum || 0, i = n.a2a_counts_summed;
        ...
        bonus: function (e, a, t, n) {
            var o, i, l, r = a2a_config.counts, s = "%3A%2F%2F";
        ...
        facebook: {
            api: ["https://graph.facebook.com/?id=", "&callback"], cb: function (e, a) {
        ...
        twitter: {
            api: ["https://cdn.api.twitter.com/1/urls/count.json?url="], cb: function (e, a) {
                if (e && !isNaN(e.count)) return e.count
            }
        }
    },
    overlays: function () {
        var e = a2a.c.overlays || [], a = !!a2a.evOpts() && {passive: !0}, t = window, n = t.innerWidth,
            o = t.innerHeight, i = n && (n < 375 || o < 375) ? 150 : 200, l = 200, r = location.href,
            s = document.title || r;

        function c(e, a, t, n) {
            var o, c, d, u, p, m, _, f, g, h,
                v = (h = e).target ? 3 === h.target.nodeType ? h.target.parentNode : h.target : h.srcElement, y = v,
                k = 0, b = 0, x = v.longDesc;
            if (a2a.matches(v, n) && "false" !== v.getAttribute("data-a2a-overlay")) {
                ...
                for (; (o = y) && "body" !== y.tagName.toLowerCase();) {
                    if (o === a) return;
                    y = y.parentNode
                }
        ...
        for (var d = 0, u = e.length; d < u; d++) {
            var p, m = e[d], _ = m.services || ["pinterest", "facebook"], f = "", g = m.html, h = m.position,
                v = m.style, y = m.size || 32, k = m.target, w = Math.round;
            if (h = h && h.length > 2 ? h.split(" ") : ["top", "left"], v = !v || "horizontal" !== v && "default" !== v ? "vertical" : "default", k = k || "img", g) document.body.insertAdjacentHTML("beforeend", g), p = document.body.lastChild; else {
    ...
    init_show: function () {
        var e = a2a_config, a = a2a[a2a.type], t = a2a.show_menu;
        e.bookmarklet && (a.no_hide = 1, t()), e.show_menu && (a.no_hide = 1, t(!1, e.show_menu))
    },
    unindexed: function (e, a) {
        function t(a) {
            for (var t, n, o = 0, i = a.length; o < i; o++) if (("undefined" == typeof(t = a[o]).a2a_index || "" === t.a2a_index) && t.className.indexOf("a2a_target") < 0 && t.parentNode.className.indexOf("a2a_kit") < 0 && (n = e(t)), n) return n;
            return null
        }
    ...
    matches: function (e, a) {
        var t, n = "MatchesSelector", o = "ms" + n, i = "webkit" + n;
    ...
    in_array: function (e, a, t, n, o) {
        if ("object" == typeof a) {
            e = e.toLowerCase();
            for (var i, l = a.length, r = 0; r < l; r++) if (i = n ? a[r][n] : a[r], i = o ? i[o] : i, t) {
    ...
    miniLeaveDelay: function () {
        var e = a2a.type, a = "a2a" + e, t = a2a.gEl, n = a2a.getStyle;
    ...
    do_find: function () {
        var e, a = a2a.type, t = a2a[a].main_services, n = t.length, o = a2a.gEl("a2a" + a + "_find").value,
            i = a2a.in_array;
        if ("" !== o) {
            e = o.split(" ");
    ...
    selection: function (e) {
        var a, t, n = document.getElementsByTagName("meta"), o = n.length;
        ...
        if (a && "" !== a) return a;
        if (a2a["n" + a2a.n].linkurl === location.href && -1 === ["facebook", "twitter", "linkedin", "google_plus"].indexOf(e)) for (var i, l, r = 0; r < o; r++) if (i = (i = n[r].getAttribute("name")) ? i.toLowerCase() : "", l = (l = n[r].getAttribute("property")) ? l.toLowerCase() : "", i && "description" === i || l && "og:description" === l) {
    ...
    cbs: function (e, a) {
        var t = a2a.c.callbacks || [], n = a2a.c.tracking_callback, o = {};
        n && (n[e] ? t.push(n) : n[0] == e ? (o[e] = n[1], t.push(o)) : "function" == typeof n && (o[e] = n, t.push(o)), a2a.c.tracking_callback = null);
        for (var i, l = 0, r = t.length; l < r; l++) if ("function" == typeof(i = t[l][e]) && (returned = i(a), "ready" == e && (i = null), "undefined" != typeof returned)) return returned
    },
    linker: function (e) {
        var a, t, n = location.href, o = document.title || n, i = a2a["n" + (e.parentNode.a2a_index || a2a.n)],
            l = i.type, r = e.a2a.safename, s = i.linkurl_implicit && n != i.linkurl ? n : i.linkurl,
            c = encodeURIComponent(s).replace(/'/g, "%27"), d = i.linkname_implicit && o != i.linkname ? o : i.linkname,
            u = encodeURIComponent(d).replace(/'/g, "%27"), p = i.linkmedia,
            ...
            g = e.a2a.customserviceuri || !1, h = e.a2a.stype, v = e.a2a.js_src, y = e.a2a.url, k = e.a2a.media,
            w = a2a.c.templates, b = w[r], x = "email";
        ...
        if (k && m) ; else if (h && "js" == h && v) e.target = "", a = "javascript:" == v.substr(0, 11) ? v.replace("${link}", s) : 'javascript:a2a.loadExtScript("' + v + '")'; else if (y && (r != x || r == x && a2a.has_touch) && !f) {
            if (e.target = "", "object" == typeof b) for (var E in b) y = a2a.urlParam(y, E, A(b[E])); else "string" == typeof b && (y = a2a.urlParam(y, "text", A(b)));
        ...
        return e.href = a || "http" + a2a.c.http_s + "://www.addtoany.com/add_to/" + r + "?linkurl=" + c + "&linkname=" + u + (m ? "&linkmedia=" + m : "") + f + (t = "", b ? t = "&" + a2a.serialize({template: b}) : w[x] && h && h == x && (t = "&" + a2a.serialize({template: w[x]})), t) + ("feed" == l ? "&type=feed" : "") + "&linknote=" + _, !0
    },
    show_full: function (e) {
        var a = a2a.type, t = "a2a" + a, n = a2a.gEl, o = a2a.getByClass, i = n(t + "_find"), l = n(t + "_overlay"),
            r = n(t + "_full"), s = o("a2a_full_header", r)[0], c = n(t + "_full_services"),
        ...
        r.classList && a2a.getStyle(l, "transition-duration") && (r.classList.add("a2a_starting"), l.classList.add("a2a_starting")), r.style.display = l.style.display = "block", r.classList && setTimeout(function () {
            ...
            var t = (e = e || window.event).which || e.keyCode, n = document.activeElement;
            27 == t && i != n ? a2a.hide_full(a) : t > 40 && t < 91 && i != n && i.focus()
        }), e && a2a.stats("full")
    },
    hide_full: function (e) {
        var a = a2a.gEl, t = "a2a" + e, n = a(t + "_full"), o = a(t + "_overlay");
    ...
    show_menu: function (e, a) {
        ...
        var t, n, o, i, l, r, s, c, d, u, p = a2a["n" + a2a.n], m = a2a.type = p.type, _ = "a2a" + m,
            f = a2a.gEl(_ + "_dropdown"), g = a2a.has_touch, h = g ? "touchstart" : "click",
    ...
    bmBrowser: function (e) {
        var a = a2a.c.localize.Bookmark, t = a2a["n" + a2a.n];
    ...
    copyLink: function (e) {
        var a = "page", t = "a2a" + a, n = a2a.gEl, o = (a2a.getByClass, n(t + "_overlay")), i = n(t + "_full"),
            l = n(t + "_modal"), r = n("a2a_copy_link_copied"), s = n("a2a_copy_link_text");
    ...
    stats: function (e) {
        if (a2a.stats.a2a = a2a.stats.a2a || {}, !a2a.stats.a2a[e]) {
            var a = "object" == typeof window.google_prev_clients ? "&as=1" : "", t = new XMLHttpRequest;
    ...
    GA: function (e) {
        var a = window, t = a2a.type, n = function () {
        ...
        }, e || /loaded|complete/.test(document.readyState) ? n() : a2a.onLoad(n)
    },
    add_services: function () {
        var e, a = a2a.type, t = a2a.gEl, n = parseInt(a2a[a].num_services), o = t("a2a" + a + "_full_services"),
    ...
    util_frame_make: function (e) {
        var a = document.createElement("iframe"), t = document.createElement("div"), n = encodeURIComponent,
            o = document.referrer ? n(document.referrer) : "", i = n(location.href),
    ...
    top_services: function (e, a, t) {
        var n = a || a2a.type, o = a2a.in_array, i = a2a.make_service, l = parseInt(a2a[n].num_services),
    ...
    css: function () {
        var e, a, t = a2a.type, n = a2a.c, o = n.css = document.createElement("style"), i = n.color_main || "EEE",
            ...
            u = (i.toLowerCase(), n.color_link_text || "2A2A2A"), p = n.color_border || r, m = ".a2a_", _ = m + "menu",
            f = "border", g = "background-color:", h = "color:", v = "margin:", y = "padding:";
    ...
    svg: {
        ...
        set: function (e) {
            ...
            if (icons = a.icons = e, svg_tag_open = a.tagO, svg_tag_close = a.tagC, icons.a2a) for (var n, o, i, l = 0, r = t.length; l < r; l++) o = (n = t[l]).name, color = n.color, i = icons[o] ? icons[o] : icons.a2a, i = color ? a.fill(i, color) : i, n.node.innerHTML = svg_tag_open + i + svg_tag_close
        },
        load: function (e) {
            var a = a2a.svg.works(), t = new window.Image;
            t.onerror = function () {
                a2a.svg.loadCSS(!1)
            }, t.onload = function () {
        ...
        loadCSS: function (e) {
            var a = a2a.static_addtoany, t = a2a.c.static_server, n = a2a.fix_icons, o = a2a.svg.works(),
                i = window.document.createElement("link"), l = e && o && t != a ? t + "/" : a + "/svg/";
            i.rel = "stylesheet", i.href = l + ["icons.27.svg.css", "icons.27.png.css", "icons.27.old.css"][e && o ? 0 : e ? 1 : 2], a2a.head_tag.appendChild(i), n(), a2a.svg.loadCSS = n
        },
        loadJS: function () {
            var e = document, a = a2a.c.static_server, t = e.createElement("script"),
                n = e.getElementsByTagName("script")[0], o = a != a2a.static_addtoany ? a + "/" : a + "/svg/";
            t.async = !0, t.src = o + "icons.27.svg.js", n.parentNode.insertBefore(t, n), a2a.svg.loadJS = function () {
            }
        },
        works: function () {
            var e = document,
    ...
    make_service: function (e, a, t, n, o, i, l) {
        var r, s, c = document.createElement("a"), d = a2a.c, u = function () {
                a2a.linker(this)
            }, p = a2a.type, m = (o = o || {}, "a2a_svg a2a_s__default"), _ = d.icon_color, f = _ ? _.split(",", 2) : _,
            g = f ? f[0] : f, h = f ? f[1] : f;
        return c.rel = "nofollow noopener", c.className = "a2a_i", c.href = "/#" + a, c.target = "_blank", c.a2a = {}, c.a2a.safename = a, c.a2a.servicename = e, c.a2a.serviceNameLowerCase = e.toLowerCase(), c.a2a.serviceIcon = t, c.a2a.serviceColor = n, c.a2a.serviceType = o.type, c.innerHTML = "<span></span>" + e + " ", r = c.firstChild, o.type && (c.a2a.stype = o.type), o.src && (c.a2a.js_src = o.src), o.url && (c.a2a.url = o.url), o.pu && (c.a2a.popup = 1), o.media && (c.a2a.media = 1), i && (c.a2a.customserviceuri = i), l ? (r.style.backgroundImage = "url(" + l + ")", r.className = m) : _ && a2a.svg.works() ? (r.className = m + " a2a_s_" + t, g && "unset" != g ? r.style.backgroundColor = g : n && (r.style.backgroundColor = "#" + n), h && (h = h.trim())) : t ? (r.className = m + " a2a_s_" + t, n && (r.style.backgroundColor = "#" + n)) : r.className = m, l || "pending" !== (s = a2a.svg.get(t, r, h)) && (r.innerHTML = s), a2a.add_event(c, "mousedown", u), a2a.add_event(c, "keydown", u), a2a.add_event(c, "click", function (a) {
            var t = a2a["n" + a2a.n], n = {node: c, service: e, title: t.linkname, url: t.linkurl, media: t.linkmedia},
                o = a2a.cbs("share", n);
            ...
            var n = encodeURIComponent, o = a2a["n" + a2a.n], i = "page" == p ? "pages" : "subscriptions",
                l = "page" == p ? "AddToAny Share/Save Button" : "AddToAny Subscribe Button", r = screen.height,
...
a2a.c = a2a_config, a2a.make_once = function (e) {
    if (a2a.type = a2a.c.menu_type || e, !a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
        a2a[a2a.type] = {}, window.a2a_show_dropdown = a2a.show_menu, window.a2a_miniLeaveDelay = a2a.miniLeaveDelay, window.a2a_init = a2a.init, a2a["create_" + a2a.type + "_dropdown"] = function (e, a) {
            var t, n, o, i = a2a.gEl, l = a2a.type = e, r = "a2a" + l, s = a2a.c, c = a2a.ieo(), d = a2a.has_menter,
                u = document.createElement("i"), p = document.createDocumentFragment(),
                m = document.createDocumentFragment(), _ = (document.createElement("a"), s.icon_color),
                f = _ ? _.split(",", 2) : _, g = f ? f[0] : f, h = f ? f[1] : f, v = "a2a_svg a2a_s__default a2a_s_",
                y = h || "#FFF", k = ' style="background-color:' + (g && "unset" != g ? g : "#0166ff") + '"',
            ...
            var A = "a2a_menu_container", E = i(A) || document.createElement("div");
            a2a.add_event(E, "click", a2a.stopPropagation), a2a.add_event(E, "touchstart", a2a.stopPropagation, !!a2a.evOpts() && {passive: !0}), E.innerHTML = x, E.id != A && (E.style.position = "static", c && c < 9 ? document.body.insertBefore(E, document.body.firstChild) : document.body.insertBefore(E, null));
            var C = a2a.make_service;
            if ("mail" != l) {
                for (var B = 0, S = a.most, F = S.length, N = parseInt(a2a[l].num_services), T = 0, L = a2a[l].exclude_services; B < F; B++) {
                    var D = S[B];
                    L && a2a.in_array(D[1], L, !0) || p.appendChild(C(D[0], D[1], D[2], D[3], D[4])), !(T < N) || L && a2a.in_array(D[1], L, !0) || (m.appendChild(C(D[0], D[1], D[2], D[3], D[4])), T++)
                }
            ...
            for (var z = a.email, I = z.length; B < I; B++) {
                D = z[B];
                L && a2a.in_array(D[1], L, !0) || i(r + "_2_col1").appendChild(C(D[0], D[1], D[2], D[3], D[4]))
            }
            if ("feed" != l) {
                var M = C("Email app", "email_app", "email", null, null, "mailto:?subject=A2A_LINKNAME_ENC&body=A2A_LINKURL_ENC");
                M.className = "a2a_i a2a_emailer a2a_email_client", M.id = "a2a" + l + "_email_client", M.target = "", i(r + "_2_col1").appendChild(M)
            }
            a2a[l].services = a.most.concat(a.email), "mail" != l && (a2a.add_event(i(r + "_overlay"), "click", function (e) {
                ...
                if (13 == a) {
                    for (var n, i = 0, l = a2a[t].main_services, r = l.length; i < r; i++) if ("none" != (n = l[i]).style.display) return n.focus(), !1
        ...
        var a = {
            page: {
                most: [["Facebook", "facebook", "facebook", "3B5998", {
                    ...
                    type: "email",
                    pu: 1
                }], ["WhatsApp", "whatsapp", "whatsapp", "12AF0A"], ["StumbleUpon", "stumbleupon", "stumbleupon", "EF4E23"], ["Amazon Wish List", "amazon_wish_list", "amazon", "F90"], ["AOL Mail", "aol_mail", "aol", "2A2A2A", {
                    type: "email",
                    pu: 1
        ...
        var t = a2a.type, n = a2a[t], o = "feed" == t ? "feed" : "page", i = a2a.c;
