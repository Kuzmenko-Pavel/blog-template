...
function theme_get_sections()
{
    ...
    $theme_sections[] = array("id" => "theme_buttons",
...
function theme_get_settings()
{
    ...
    $theme_settings[] = array("name" => "RSS URL",
    ...
    $theme_settings[] = array("name" => "Twitter",
    ...
    $theme_settings[] = array("name" => "Facebook",
    ...
    $theme_settings[] = array("name" => "Google+",
    ...
    $theme_settings[] = array("name" => "LinkedIn",
    ...
    $theme_settings[] = array("name" => "Youtube",
