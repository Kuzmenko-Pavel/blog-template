...
class Easy_Social_Share_Buttons {
	...
	public function enqueue_scripts() {
		...
		wp_localize_script( $this->_token . '-script', $this->_token . '_ajax_vars', array(
			$this->_token . '_ajax_nonce' => wp_create_nonce( 'essb_ajax_nonce' ),
           ...
           target="_blank">
			...
			<?php if ( $service == 'link' ) : ?>
                <div class="ess-share-link-wrap">
                    <input class="ess-share-link" type="text" value="<?php echo $popup_url; ?>"
                           onclick="javascript:this.setSelectionRange(0, this.value.length); return false;"/>
                </div>
			<?php endif; ?>
